...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppSignupSignupPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<span>\n  <ion-buttons slot=\"end\" class=\"position-set\">\n    <ion-button size=\"large\" color=\"primary\" (click)=\"goToLogin()\">LOGIN</ion-button>\n  </ion-buttons>\n</span>\n<ion-content>\n  <ion-item lines =\"none\" style=\"margin-top: 40px; \">\n    <ion-thumbnail slot=\"start\" class=\"img-center\">\n      <img src=\"assets/icon/Rent2Trust.jpeg\" style=\"width: 45%;\">\n    </ion-thumbnail>\n  </ion-item>\n  <ion-list lines=\"full\" class=\"ion-no-margin ion-no-padding\">\n\n    <ion-item class=\"remove-line-item\">\n      <ion-label position=\"stacked\" style=\"margin-bottom: 5px;\">Name <ion-text color=\"danger\">*</ion-text>\n        <br><div no-padding class=\"errMsgLogin\" >{{nameError}}</div>\n      </ion-label>\n      <ion-input [(ngModel)]=\"name\" name=\"name\" required type=\"text\" (ionChange)=\"checkInputValue('name')\"></ion-input>\n    </ion-item>\n\n    <ion-item class=\"remove-line-item\">\n      <ion-label position=\"stacked\" style=\"margin-bottom: 5px;\">Email <ion-text color=\"danger\">*</ion-text>\n        <br><div no-padding class=\"errMsgLogin\" >{{emailError}}</div>\n      </ion-label>\n      <ion-input [(ngModel)]=\"email\" name=\"email\" required type=\"text\" (ionChange)=\"checkInputValue('email')\"></ion-input>\n    </ion-item>\n\n    <ion-grid>\n      <ion-row>\n        <ion-col width-50>\n          <ion-item class=\"remove-line-item\" style=\"margin-left: -10px;\">\n            <ion-label position=\"fixed\" style=\"margin-bottom: 5px; zoom: 0.9;\">\n                Mobile No\n            </ion-label>\n            <ion-select placeholder=\"Select\" interface=\"action-sheet\" [(ngModel)]=\"countryCode\">\n              <ion-select-option value=\"+91\">+91</ion-select-option>\n              <ion-select-option value=\"+1\">+1</ion-select-option>\n            </ion-select>\n            <br><div no-padding class=\"errMsgLogin\" >{{mobileNoError}}</div>\n          </ion-item>\n        </ion-col>\n        \n        <ion-col width-50>\n          <ion-item lines=\"full\" class=\"remove-line-item\">\n            <ion-input type=\"tel\"  maxlength=\"10\" [(ngModel)]=\"mobileNumber\" name=\"mobileNumber\" required (ionChange)=\"checkInputValue('mobileNumber')\">\n            </ion-input>\n          </ion-item>\n        </ion-col>\n       </ion-row>\n    </ion-grid>\n\n    <ion-item class=\"remove-line-item\">\n      <ion-label position=\"stacked\" style=\"margin-bottom: 5px;\">Address <ion-text color=\"danger\">*</ion-text>\n        <br><div no-padding class=\"errMsgLogin\" >{{addressError}}</div>\n      </ion-label>\n      <ion-input type=\"text\" [(ngModel)]=\"address1\" name=\"address1\" required (ionChange)=\"checkInputValue('address1')\" placeholder=\"Address Line 1\"></ion-input>\n      <ion-input type=\"text\" [(ngModel)]=\"address2\" name=\"address2\" required (ionChange)=\"checkInputValue('address2')\" placeholder=\"Address Line 2\"></ion-input>\n      <ion-input type=\"text\" [(ngModel)]=\"state\" name=\"state\" required (ionChange)=\"checkInputValue('state')\" placeholder=\"State\"></ion-input>\n      <ion-input type=\"text\" [(ngModel)]=\"city\" name=\"city\" required (ionChange)=\"checkInputValue('city')\" placeholder=\"City\"></ion-input>\n      <ion-input type=\"text\" [(ngModel)]=\"country\" name=\"country\" required (ionChange)=\"checkInputValue('country')\" placeholder=\"Country\"></ion-input>\n      <ion-input type=\"number\" [(ngModel)]=\"zipcode\" name=\"zipcode\" required (ionChange)=\"checkInputValue('zipcode')\" placeholder=\"Zip Code\"></ion-input>\n    </ion-item>\n\n    <ion-item class=\"remove-line-item\">\n      <ion-label position=\"stacked\" style=\"margin-bottom: 5px;\"> Profile Photo <ion-text color=\"danger\">*</ion-text>\n        <br><div no-padding class=\"errMsgLogin\" >{{profilePhotoError}}</div>\n      </ion-label>\n        <ion-grid>\n          <ion-row>\n            <ion-col size=\"6\" *ngIf=\"profileImage\">\n                <ion-avatar style=\"margin-right: 100px;\" [(ngModel)]=\"profilePhoto\">\n                  <img src=\"{{computDecodeURI(profileImage)}}\">\n                </ion-avatar>\n            </ion-col>\n            <ion-col (click)=\"handlePhotoValue()\" size=\"6\" class=\"ion-align-self-center\">\n              <ion-icon size=\"large\" name=\"camera-outline\" class=\"icon-radius\"></ion-icon>\n            </ion-col>\n        </ion-row>\n      </ion-grid>\n    </ion-item>\n\n    <ion-item class=\"remove-line-item\">\n      <ion-label style=\"margin-bottom: 5px;\"> Identity Proof {{country}} <ion-text color=\"danger\">*</ion-text>\n        <br><div no-padding class=\"errMsgLogin\" >{{identityProofError}}</div>\n      </ion-label>\n        <ion-select interface=\"popover\" [(ngModel)]=\"identityProof\">\n          <ion-select-option value=\"aadhaar\" *ngIf=\"country.toLowerCase() == 'india'\">Aadhaar card</ion-select-option>\n          <ion-select-option value=\"driving\" *ngIf=\"country.toLowerCase() == 'india'\">Driving license</ion-select-option>\n          <ion-select-option value=\"pan\" *ngIf=\"country.toLowerCase() == 'india'\">Pan Card</ion-select-option>\n          <ion-select-option value=\"voter\" *ngIf=\"country.toLowerCase() == 'india'\">Voter Card</ion-select-option>\n          <ion-select-option value=\"passport\">Passport</ion-select-option>\n          <ion-select-option value=\"sin-no.\" *ngIf=\"country.toLowerCase() == 'canada'\">Sin No.</ion-select-option>\n          <ion-select-option value=\"student-visa\" *ngIf=\"country.toLowerCase() == 'canada'\">Student visas</ion-select-option>\n          <ion-select-option value=\"pr\" *ngIf=\"country.toLowerCase() == 'canada'\">PR card</ion-select-option>\n        </ion-select>\n    </ion-item>\n    <ion-item class=\"remove-line-item\">\n      <ion-grid>\n        <ion-row>\n          <ion-col size=\"6\" *ngIf=\"identityProofImage\">\n              <ion-avatar style=\"margin-right: 100px;\">\n                <img src=\"{{computDecodeURI(identityProofImage)}}\">\n              </ion-avatar>\n          </ion-col>\n          <ion-col (click)=\"clickIdentityPhoto()\" size=\"6\" class=\"ion-align-self-center\">\n            <ion-icon size=\"large\" name=\"camera-outline\" style=\"margin-left: 50px;\" class=\"icon-radius\"></ion-icon>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n    </ion-item>\n\n  </ion-list>\n</ion-content>\n\n<ion-footer>\n  <ion-button expand=\"block\" type=\"submit\" class=\"ion-no-margin\" tappable (click)=\"createAccount($event)\">Sign Up</ion-button>\n</ion-footer>\n";
    /***/
  },
  ...
  function srcAppSignupSignupPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".img-center {\n  width: 100%;\n  margin: 20px auto;\n  text-align: center;\n  height: 100px;\n}\n\n.icon-radius {\n  margin-left: 50px;\n  border-radius: 50%;\n  border: 1px solid black;\n}\n\n.position-set {\n  position: absolute;\n  right: 0px;\n  margin-right: 5px;\n  margin-top: 5px;\n}\n\n.remove-line-item {\n  border-bottom: 0px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(toastCtrl, databaseService, authdataService, router, loadingCtrl) {
      ...
      _createClass(SignupPage, [{
        ...
        value: function goToLogin() {
          var self = this; //navigate to login page for all use
        ...
        key: "checkInputValue",
        value: function checkInputValue(inputValue) {
          var self = this;
        ...
        value: function createAccount(event) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var self, currentTarget, email, enteredEmail, emailPattern, enteredNumber, phoneno, countryCode, object, addressDetail, identityDetail;
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    self = this;
                    currentTarget = event.currentTarget; //Set the boolean variable for validate the field validation
                  ...
                  case 24:
                    ...
                    enteredEmail = email.toLowerCase(); //var emailPattern = /^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$/;

                    emailPattern = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i; //Here we will match the input email with the emailPattern
                  ...
                  case 45:
                    enteredNumber = self.mobileNumber;
                  ...
                  case 54:
                    ...
                    object["address"] = addressDetail; // self.authService.signup(function(isSuccess){
                    // if(isSuccess) {

                    self.databaseService.addUser(function (isSuccess) {
                      if (isSuccess) {
                        self.showSuccessToast("Account Created Successfully"); //navigate to login page for all use
        ...
        key: "handlePhotoValue",
        value: function handlePhotoValue(event) {
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return Camera.getPhoto({
                      ...
                      direction: _capacitor_core__WEBPACK_IMPORTED_MODULE_5__["CameraDirection"].Front
                    });

                  case 3:
                    image = _context2.sent;
                    // Can be set to the src of an image now
                    this.profileImage = image.dataUrl; //created compress images
        ...
        key: "clickIdentityPhoto",
        value: function clickIdentityPhoto() {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    ...
                    // Can be set to the src of an image now
                    this.identityProofImage = image.dataUrl; //created compress images
        ...
        key: "computDecodeURI",
        value: function computDecodeURI(url) {
          return decodeURIComponent(url);
        } //compressImagePath

      }, {
        key: "compressImagePath",
        value: function compressImagePath(img) {
          ...
          image.onload = function () {
            ...
            var height = image.height * scaleFactor; // img.width and img.height will contain the original dimensions

            ctx.drawImage(image, 0, 0, width, height);
            var dataUrl = canvas.toDataURL('image/jpeg', quality);
            self.authdataService.addPhotoFromCamera(function (isImageAdded, imageDownloadURL) {
              if (isImageAdded) {
        ...
        value: function showSuccessToast(messages) {
