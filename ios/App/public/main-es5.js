...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppModule = function AppModule() {
      ...
      firebase__WEBPACK_IMPORTED_MODULE_11__["initializeApp"](src_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase);
    };

    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"]],
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_10__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_12__["Camera"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_14__["AuthGuardService"], _app_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"], {
  ...
  function srcAppServicesAuthGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthGuardService = /*#__PURE__*/function () {
      function AuthGuardService(router, menuCtrl) {
      ...
      _createClass(AuthGuardService, [{
        ...
        value: function canActivate(next, state) {
          ...
          var self = this; // here we check if user is logged in or not
          ...
          return new Promise(function (resolve, reject) {
            ...
            var localUserId = localStorage.userId; //const localUserData = this.localService.localUserData;

            if (!localUserId && _this2.routeURL !== '/login') {
              _this2.routeURL = '/login'; // when the user is not logged in,
              ...
              _this2.routeURL = _this2.router.url; // just return true - if user is logged in
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService() {
        ...
        var self = this; //creates a firebase auth reference, now you can get access to all the auth methods with this.fireAuth

        this.fireAuth = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]();
        this.STORAGE_REF = firebase__WEBPACK_IMPORTED_MODULE_2__["storage"]();
      ...
      _createClass(AuthService, [{
        ...
        value: function addPhotoFromCamera(callback, imageString, type) {
          var self = this; //Uplaod file

          var image = imageString;
          var IMAGE_STORAGE_REF;

          if (!imageString.startsWith("data:image")) {
            image = "data:image/jpeg;base64,".concat(imageString);
          }
          ...
          rn = type + rn;
          var task = IMAGE_STORAGE_REF.child(rn).putString(image, 'data_url'); //update progress bar
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      production: false,
      firebase: {
        apiKey: "AIzaSyA07KeDT_58GiLqRtkF29Lb3bfiDS3IXuo",
        authDomain: "track2rent.firebaseapp.com",
        databaseURL: "https://track2rent.firebaseio.com",
        projectId: "track2rent",
        storageBucket: "track2rent.appspot.com",
        messagingSenderId: "882375837496",
        appId: "1:882375837496:web:99f2201fe8f531a513e3cd",
        measurementId: "G-E6WVNMC4RR"
      }
    };
    /*
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! G:\users\keshav\git\Rent2Trust-Delivery\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
