...
let SignupPage = class SignupPage {
    constructor(toastCtrl, databaseService, authdataService, router, loadingCtrl) {
    ...
    //compressImagePath
    compressImagePath(img, quality = 1, type, callback) {
        let self = this;
