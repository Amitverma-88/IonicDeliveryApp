  ...
  function srcAppServicesDatabaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DatabaseService = /*#__PURE__*/function () {
      function DatabaseService() {
        ...
        //promise handle
        this.returnPromise = function (isSuccess, data, docRef) {
          return {
            isSuccess: isSuccess,
            data: data,
            docRef: docRef
      ...
      _createClass(DatabaseService, [{
        key: "addUser",
        value: function addUser(callback, userObj) {
          userObj["timeStamp"] = firebase__WEBPACK_IMPORTED_MODULE_2__["firestore"].FieldValue.serverTimestamp();
          userObj['timestampUpdate'] = firebase__WEBPACK_IMPORTED_MODULE_2__["firestore"].FieldValue.serverTimestamp();
          var docRefId = this.db.collection("UserCollection").doc().id;
          userObj['userId'] = docRefId;
          var docRef = this.db.collection("UserCollection").doc(docRefId).set(userObj).then(function (docRef) {
        ...
        key: "checkEmailOrNumberExistGCP",
        value: function checkEmailOrNumberExistGCP(object) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 6;
                    return this.db.collection("UserCollection").where("phoneNumber", "==", object.countryCode + Number(object.data)).get();
                  ...
                  case 9:
                    _context3.next = 11;
                    return this.db.collection("UserCollection").where("email", "==", object.data.toLowerCase()).get();
                  ...
                  case 19:
                    ...
                    console.log("errorDocuments", _context3.t0);
                    return _context3.abrupt("return", false);
        ...
        key: "getUserDataByPhoneNo",
        value: function getUserDataByPhoneNo(phoneNumber) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
            var dataArray, docRef, querySnapshot;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.prev = 0;
                    dataArray = [];
                    docRef = this.db.collection('UserCollection');
                    _context4.next = 5;
                    return docRef.where("phoneNumber", "==", phoneNumber).get();
                  ...
                  case 5:
                    ...
                    return _context4.abrupt("return", this.returnPromise(true, dataArray, docRef));

                  case 9:
                    return _context4.abrupt("return", this.returnPromise(false, null, docRef));

                  case 12:
                    _context4.prev = 12;
                    _context4.t0 = _context4["catch"](0);
                    return _context4.abrupt("return", this.returnPromise(false, _context4.t0, null));
